...
#[ic_cdk_macros::query(name = "get_player_rewards")]
#[candid::candid_method(query, rename = "get_player_rewards")]
async fn _cdk_user_defined_get_player_rewards(
    _cdk_user_defined_player: candid::Principal,
) -> (Option<Vec<String>>) {
    let interpreter = unsafe { INTERPRETER_OPTION.as_mut() }
        .unwrap_or_trap("SystemError: missing python interpreter");
    let vm = &interpreter.vm;
    let params = (_cdk_user_defined_player
        .try_into_vm_value(vm)
        .unwrap_or_trap(),);
    call_global_python_function("get_player_rewards", params)
        .await
        .unwrap_or_trap()
}
#[ic_cdk_macros::query(name = "get_player_statistics")]
#[candid::candid_method(query, rename = "get_player_statistics")]
async fn _cdk_user_defined_get_player_statistics(
    _cdk_user_defined_player: candid::Principal,
) -> (String) {
    let interpreter = unsafe { INTERPRETER_OPTION.as_mut() }
        .unwrap_or_trap("SystemError: missing python interpreter");
    ...
    let params = (_cdk_user_defined_player
        .try_into_vm_value(vm)
        .unwrap_or_trap(),);
    call_global_python_function("get_player_statistics", params)
        .await
        .unwrap_or_trap()
}
#[ic_cdk_macros::query(name = "get_leaderboard")]
#[candid::candid_method(query, rename = "get_leaderboard")]
async fn _cdk_user_defined_get_leaderboard() -> (String) {
    let interpreter = unsafe { INTERPRETER_OPTION.as_mut() }
        .unwrap_or_trap("SystemError: missing python interpreter");
    let vm = &interpreter.vm;
    let params = ();
    call_global_python_function("get_leaderboard", params)
        .await
        .unwrap_or_trap()
}
#[ic_cdk_macros::update(name = "join_game")]
#[candid::candid_method(update, rename = "join_game")]
async fn _cdk_user_defined_join_game(_cdk_user_defined_player: candid::Principal) -> (String) {
    let interpreter = unsafe { INTERPRETER_OPTION.as_mut() }
        .unwrap_or_trap("SystemError: missing python interpreter");
    let vm = &interpreter.vm;
    let params = (_cdk_user_defined_player
        .try_into_vm_value(vm)
        .unwrap_or_trap(),);
    call_global_python_function("join_game", params)
        .await
        .unwrap_or_trap()
}
#[ic_cdk_macros::update(name = "set_bet")]
#[candid::candid_method(update, rename = "set_bet")]
async fn _cdk_user_defined_set_bet(
    _cdk_user_defined_player: candid::Principal,
    _cdk_user_defined_bet_amount: candid::Nat,
) -> (String) {
    let interpreter = unsafe { INTERPRETER_OPTION.as_mut() }
        .unwrap_or_trap("SystemError: missing python interpreter");
    let vm = &interpreter.vm;
    let params = (
        _cdk_user_defined_player
            .try_into_vm_value(vm)
            .unwrap_or_trap(),
        _cdk_user_defined_bet_amount
            .try_into_vm_value(vm)
            .unwrap_or_trap(),
    );
    call_global_python_function("set_bet", params)
        .await
        .unwrap_or_trap()
}
#[ic_cdk_macros::update(name = "advance_level")]
#[candid::candid_method(update, rename = "advance_level")]
async fn _cdk_user_defined_advance_level(_cdk_user_defined_player: candid::Principal) -> (String) {
    let interpreter = unsafe { INTERPRETER_OPTION.as_mut() }
        .unwrap_or_trap("SystemError: missing python interpreter");
    let vm = &interpreter.vm;
    let params = (_cdk_user_defined_player
        .try_into_vm_value(vm)
        .unwrap_or_trap(),);
    call_global_python_function("advance_level", params)
        .await
        .unwrap_or_trap()
}
#[ic_cdk_macros::update(name = "withdraw_rewards")]
#[candid::candid_method(update, rename = "withdraw_rewards")]
async fn _cdk_user_defined_withdraw_rewards(
    _cdk_user_defined_player: candid::Principal,
) -> (String) {
    let interpreter = unsafe { INTERPRETER_OPTION.as_mut() }
        .unwrap_or_trap("SystemError: missing python interpreter");
    ...
    let params = (_cdk_user_defined_player
        .try_into_vm_value(vm)
        .unwrap_or_trap(),);
    call_global_python_function("withdraw_rewards", params)
        .await
        .unwrap_or_trap()
}
#[derive(
