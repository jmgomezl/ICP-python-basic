...
import { idlFactory } from './mines_game.did.js';
export { idlFactory } from './mines_game.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_MINES_GAME;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./mines_game.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the mines_game canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./mines_game.did.js")._SERVICE>}
 */
export const mines_game = createActor(canisterId);
